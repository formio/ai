...
| --- | --- | --- |
| stdio | `npx -y @formio/mcp@0.13.0` (or `node dist/stdio.js`) | Claude Code, Claude Desktop, Cursor, VS Code, Codex, Windsurf, Cline — anything that speaks MCP over stdio |
