...
import { registerFormDraftCreateTool } from './form_draft_create.js';
import { registerFormDraftGetTool } from './form_draft_get.js';
import { registerFormDraftPublishTool } from './form_draft_publish.js';
...
import { registerFormRevisionsSetTool } from './form_revisions_set.js';
...
export function registerAllTools(
  ...
  registerFormDraftCreateTool(server, config);
  registerFormDraftGetTool(server, config);
  registerFormDraftPublishTool(server, config);
  ...
  registerFormRevisionsSetTool(server, config);
