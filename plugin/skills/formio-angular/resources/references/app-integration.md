...
@NgModule({
  ...
  providers: [
    // Explicit change-detection provider is added by BOOTSTRAP (see BOOTSTRAP.md Step 6).
    FormioAuthService,
    FormioResources,
