...
### POST {baseUrl}/project (create tenant)
...
### GET {baseUrl}/project?project=:projectId&type=tenant
...
### POST {baseUrl}/project/:tenantId/admin/submission
...
### POST {baseUrl}/project/:tenantId/admin/login
...
curl -D - -X POST -H "Content-Type: application/json" \
  ...
  "{baseUrl}/project/<tenantId>/admin/login"
```

### POST {baseUrl}/project/:tenantId/form
...
### DELETE {baseUrl}/project/:tenantId
