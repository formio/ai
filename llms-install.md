...
```sh
npx -y @formio/mcp project set --project-url <url> --base-url <url> --cwd <absolute path>
npx -y @formio/mcp project get --cwd <absolute path>
```
