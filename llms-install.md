...
```json
{ "command": "npx", "args": ["-y", "@formio/mcp@0.12.3"] }
```
...
```sh
npx -y @formio/mcp@0.12.3 project set --project-url <url> --base-url <url> --cwd <absolute path>
npx -y @formio/mcp@0.12.3 project get --cwd <absolute path>
```
