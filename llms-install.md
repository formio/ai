...
```json
{ "command": "npx", "args": ["-y", "@formio/mcp@0.10.0"] }
```
...
```sh
npx -y @formio/mcp@0.10.0 project set --project-url <url> --base-url <url> --cwd <absolute path>
npx -y @formio/mcp@0.10.0 project get --cwd <absolute path>
```
