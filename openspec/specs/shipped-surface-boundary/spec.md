# shipped-surface-boundary Specification

## Purpose
Defines what may live in the tree a consumer installs: only what that consumer needs, with eval harnesses kept outside it and initiative artifacts kept local rather than committed.
## Requirements
