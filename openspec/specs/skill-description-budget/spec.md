...
Defines the character budget every top-level skill description must fit, the rule that a description carries routing content only, and the structural test suite that enforces both library-wide.
## Requirements
