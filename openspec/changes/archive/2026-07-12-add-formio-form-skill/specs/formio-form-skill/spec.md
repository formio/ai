...
- **THEN** its `description` contains a `Not for:` clause containing the literal substrings `formio-angular`, `formio-application`, `formio-resource-planner`, `formio-api`, and `formio-sdk`
